    ...
    <section id='about'>
        <div className='mb-16 md:px-0 px-5'>
            <div className='content'>
                ...
                <div className='sub-content'>
                    ...
                    <div>
                        <p className='md:text-3xl text-xl font-bold'><span>4.5</span></p>
        ...
        <div className='top-grid'>
            ...
            <div className='col-span-6'>
                <div className='noisy'>
                    <img src="/images/abt2.png" alt="grid-img-1"></img>
                </div>
            </div>

            <div className='col-span-3'>
                <div className='noisy'>
                    <img src="/images/abt5.png" alt="grid-img-1"></img>
                </div>
            </div>
         ...
         <div className='bottom-grid'>
                ...
                <div className='noisy'>
                    <img src="/images/abt3.png" alt="grid-img-1"></img>
                </div>
            </div>
            
             <div className='col-span-4'>
                <div className='noisy'>
                    <img src="/images/abt4.png" alt="grid-img-1"></img>
                </div>
            </div>
            </div>
    </section>
